...
<ul>
    ...
    <li>Knowledge in:</li>
        <ul>
            ...
            <li> HTML/CSS/JS <img width="25" height="25" src="public/images/html-5.png"> <img width="25" height="25" src="public/images/css3_brand.png"> <img width="25" height="25" src="public/images/js_brand.png"></li>
            <li> MongoDB </li>
